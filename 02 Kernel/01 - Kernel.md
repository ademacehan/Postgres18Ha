# Postgres Sunucularda Kernel İşlemleri
...
Örnek 8GB ram için hesaplanması

8 * 1024 * 1024 * 1024 = 8589934592
(Gb) (mb)  (kb)   (byte)

```bash
echo "kernel.shmmax = 34359738368" | sudo tee /etc/sysctl.d/99-postgresql.conf
```
...
8589934592/4096 = 17318416  
```bash
echo "kernel.shmall = 8388608" | sudo tee -a /etc/sysctl.d/99-postgresql.conf
```
